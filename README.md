...
<body>
    ...
    <div id="controls">
        ...
        <!-- We use an ID for the button now to attach event listener in JS -->
    ...
    <script>
        // All code is now inside this load event listener
        window.onload = function() {
            const nameInput = document.getElementById('nameInput');
            const gameArea = document.getElementById('game-area');
            const dropButton = document.getElementById('dropButton'); // Get the button by ID
            ...
            // Attach the click handler to the button using JavaScript
            dropButton.addEventListener('click', addBallFromInput);
